...
export default function SignUp() {
  ...
  return (
      ...
      <Grid container  sx={{ height: '50%', width: '75%', marginTop:5, marginLeft:30}} >
        ...
        <Grid item xs={12} sm={4} md={6} component={Paper} elevation={6} square>
          ...
          >
            ...
            <Button
                ...
                sx={{ mt: 2, mb: 2, borderRadius:30, p:1, "&.MuiButton-text": { color: "black" },
                border: "1px #d3d3d3 solid", fontSize:12, fontWeight:600}}
            >
              
              <Avatar
               
                 src='https://upload.wikimedia.org/wikipedia/commons/archive/5/53/20190923152039%21Google_%22G%22_Logo.svg' size={100} backgroundColor='rgba(0,0,0,0)'
