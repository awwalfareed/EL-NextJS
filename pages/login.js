    ...
    <Grid container component="main" className={classes.root} >
      ...
      <Grid item xs={12} sm={8} md={6} component={Paper} elevation={6} >
        <div className={classes.paper}>
            ...
            <OfflineBoltIcon style={{ fontSize: 55 }} color="primary" className={classes.logoLeft}/>
          ...
          <CustomButton
            ...
            >
              <Avatar
										...
										size={100} className={classes.logoGoogle}
									/>
              Sign up with Google
            </CustomButton>
            {/* {showLoginButton ? (
            ...
            <TextField
              ...
              value={password}
							...
							error={passwordError}
							helperText={passwordError ? "invalid input email" : null}
