import { makeStyles, Container, Typography, Link, Avatar, ImageList, ImageListItem, Divider } from "@material-ui/core";
...
const Rightbar = ()=>{
    ...
    return (
        <Container className={classes.container}>
            ...
            <Typography className={classes.title} gutterBottom>Galleries</Typography>
                <ImageList rowHeight={100} className={classes.imageList} cols={3} style={{marginBottom:20}}>
