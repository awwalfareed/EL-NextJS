...
const Suggestions = ({ user }) => {
	...
	return (
		<Paper className={classes.PaperMargin} variant="outlined">
			...
			<span className={classes.boldNum}>293</span>
			<span className={classes.follower}>Following</span>
			<span className={classes.boldNum}>3.5M</span>
			<span className={classes.follower}>Followers</span>
