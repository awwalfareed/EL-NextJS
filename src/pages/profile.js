			...
			<Container style={{ marginTop: "5%" }}>
				<Grid className={classes.profile}>
					...
					>
						...
						<Typography style={{ color: "gray" }}>My first posting</Typography>
						<Typography style={{ fontSize: 18 }}>
							Sofware Develope | Self Motivated | Book Lover | Traveller
						</Typography>

						<div style={{ marginTop: 20 }}>
							<span>3.5M Followers</span>
							<span style={{ marginLeft: 30 }}>500 Following</span>
						</div>
						<div
				...
				<div className={classes.root}>
					<Grid container spacing={3}>
						...
						<Grid item xs={3} sm={6}>
							...
							<div style={{ width: "143%", marginLeft: -104, marginTop: 20 }}>
								<Feed />
							</div>
						</Grid>
						<Grid item xs={6} sm={3}>
